...
namespace T89CompilerLib.OpCodes
{
    ...
    public enum ScriptOpCode : byte
    {
        ...
        ScriptChildThreadCall,
        ScriptChildThreadCallPointer,
        ScriptMethodChildThreadCall,
        ScriptMethodChildThreadCallPointer,
    ...
    public class ScriptOpMetadata
    {
        ...
        public static readonly ScriptOpMetadata[] OpInfo =
        {
            ...
            new ScriptOpMetadata(ScriptOpCode.ScriptChildThreadCall,             ScriptOpType.Call,              ScriptOperandType.Call),
            new ScriptOpMetadata(ScriptOpCode.ScriptChildThreadCallPointer,      ScriptOpType.Call,              ScriptOperandType.UInt8),
            new ScriptOpMetadata(ScriptOpCode.ScriptMethodChildThreadCall,       ScriptOpType.Call,              ScriptOperandType.Call),
            new ScriptOpMetadata(ScriptOpCode.ScriptMethodChildThreadCallPointer,ScriptOpType.Call,              ScriptOperandType.UInt8),
